...
HEALTH_SYSTEM_PROMPT = f"""You are the Health specialist for the Singapore Open Data Portal.
...
2. Sieve through the available Health datasets (COVID, healthcare, MOH, disease, hospital, etc.)
