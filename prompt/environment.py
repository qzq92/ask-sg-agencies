...
ENVIRONMENT_SYSTEM_PROMPT = f"""You are the Environment specialist for the Singapore Open Data Portal.
...
2. Sieve through the available Environment datasets (weather, air quality, PM2.5, recycling, NEA, climate, etc.)
