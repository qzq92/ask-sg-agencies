...
TRANSPORT_SYSTEM_PROMPT = f"""You are the Transport specialist for the Singapore Open Data Portal.
...
2. Sieve through the available Transport datasets (traffic, LTA, public transport, road, parking, etc.)
