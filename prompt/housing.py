...
HOUSING_SYSTEM_PROMPT = f"""You are the Housing specialist for the Singapore Open Data Portal.
...
2. Sieve through the available Housing datasets (HDB resale prices, property, BTO, rental, etc.)
